 <p align="center">
  ...
  Stack%20Software%20Engineer%20%E2%80%A2%20Lucena%20%2F%20Candelaria%2C%20Quezon%2C%20PH&descAlign=50&descAlignY=62&descSize=14" />
    ...
    <p align="center">
      ...
      &nbsp;
      <img src="https://img.shields.io/badge/Role-Lead%20Full%20Stack%20Engineer-3b82f6?style=flat-square&labelColor=0f172a" />
      &nbsp;
    ...
    const franze = {
      ...
      education: {
        ...
        graduated:   "2025",
        distinction: "Class Salutatorian (GWA: 1.22) · Magna Cum Laude",
      },
    } satisfies Engineer;
  ──────
  ## 🧰 Tech Stack
  ...
  🖼 Image: shadcn/ui → https://img.shields.io/badge/shadcn%2Fui-111111?style=flat-square
  ...
  ------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-----------------------------------------------------------------------
   MSEUF-Candelaria Portal & CMS[1]                                       | Official university portal with decoupled headless CMS & MinIO S3 storage                 | Next.js 16 · Express 5 · Prisma 7 · MinIO · MySQL
  ...
  │ 🏅 Class Salutatorian  ·  Magna Cum Laude (GWA: 1.22)
  ──────
  ## 📈 GitHub Stats
  ──────
